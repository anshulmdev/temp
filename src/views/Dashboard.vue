  ...
  <div v-if="$store.state.firestoreData">
    ...
    <div class="content">
      ...
      <b-row class="row-deck">
        <!-- Latest Customers -->
        <b-col xl="6">
          <base-block rounded title="Recent Applicants" header-bg content-full>
            <template #options>
            ...
            <b-table-simple striped hover borderless class="table-vcenter font-size-sm mb-0">
              <b-thead>
                <b-tr>
                  ...
                  <b-th class="d-none d-lg-table-cell font-w700 text-center" style="width: 100px;">Resume</b-th>
                  <b-th class="font-w700">Name</b-th>
                  <b-th class="d-none d-sm-table-cell font-w700 text-center" style="width: 80px;">Score</b-th>
        ...
        <!-- Latest Orders -->
        <b-col xl="6">
          <base-block rounded title="Ongoing Tests" header-bg content-full>
            <template #options>
              <button type="button" class="btn-block-option">
                <i class="si si-settings"></i>
              </button>
            ...
            <b-table-simple striped hover borderless class="table-vcenter font-size-sm mb-0">
              <b-thead>
                <b-tr>
                  ...
                  <b-th class="d-none d-sm-table-cell font-w700 text-right" style="width: 120px;">Score</b-th>
                  <b-th class="font-w700 text-center" style="width: 60px;"></b-th>
                </b-tr>
              </b-thead>
              <b-tbody>
      ...
      <b-row>
        <b-col lg="6">
          <!-- Earnings Chart -->
          <base-block rounded title="Open test community" header-bg>
            <template #options>
              <button type="button" class="btn-block-option">
                <i class="si si-settings"></i>
              </button>
